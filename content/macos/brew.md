...
## utilities
```
zsh-autosuggestions zsh-syntax-highlighting superfile yazi file-formula starship tmux fastfetch btop tree git-lfs yt-dlp nvtop stow mailsy imagemagick qwen-code gromgit/brewtils/taproom zoxide eza pfetch-rs ffmpeg
```
